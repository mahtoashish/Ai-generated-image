...
const OPENAI_API_KEY = "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"; // Your OpenAI API key here
...
// const OPENAI_API_KEY = "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";
...
//         const imgElement =imgCard.querySelector("img");
//         const downloadBtn=imgCard.querySelector(".download-btn");
//         // Set the image source to the AI-genrerated image data
//         const aiGeneratedImg =`data:image/jpeg;base64,${imgObject.b64_json}`;

//         imgElement.src=aiGeneratedImg;

//         // When the inage is loaded, remove the loading class
//         imgElement.onload=()=>{
//             imgCard.classList.remove("loading");
//             downloadBtn.setAttribute("href", aiGeneratedImage);
//       downloadBtn.setAttribute("download", `${new Date().getTime()}.jpg`);
